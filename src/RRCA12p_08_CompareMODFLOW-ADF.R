...
p.scatter.capture <- 
  ...
  ggsave(file.path("results", "RRCA12p_08_CompareMODFLOW-ADF_ScatterCapture.png"),
...
p.scatter.depletion <- 
  ...
  scale_y_continuous(name = "Monthly Mean Depletion, MODFLOW [m\u00b3/d]") +
  scale_color_manual(name = "Season", values = pal.season) +
  ggsave(file.path("results", "RRCA12p_08_CompareMODFLOW-ADF_ScatterDepletion.png"),
         width = 120, height = 95, units = "mm")
...
fit_match_byWell %>% 
  ...
  ggsave(file.path("results", "RRCA12p_08_CompareMODFLOW-ADF_Fit-MatchPrcByWell.png"),
...
ggplot(fit_match_bySP, aes(y = prc_match, x = SP, color = n_total)) +
  ...
  ggsave(file.path("results", "RRCA12p_08_CompareMODFLOW-ADF_Fit-MatchPrcBySP.png"),
...
fit_all_wel %>% 
 ...
 # coord_cartesian(ylim=c(-2.5,1)) +
  ggsave(file.path("results", "RRCA12p_08_CompareMODFLOW-ADF_Fit-KGEByWell.png"),
...
ggplot() + 
  ...
  ggsave(file.path("results", paste0("RRCA12p_08_CompareMODFLOW-ADF_SingleWellTimeseries_Well", w, ".png")),
         width = 190, height = 95, units = "mm")
...
ggplot(depletion_balance_all, aes(x=flux_pumped, y=depletion_m3d_modflow)) + 
  ...
  ggsave(file.path("results", "RRCA12p_08_CompareMODFLOW-ADF_Scatter-MassBalanceVsDepletion.png"),
...
ggplot() +
 # geom_tile(data = surfwat_df, aes(x = col, y = row), fill = col.gray) +
  ...
  ggsave(file.path("results", paste0("RRCA12p_08_CompareMODFLOW-ADF_SingleWellMap_Well", w, ".png")),
         width = 120, height = 95, units = "mm")
...
ggplot(subset(depletion_balance_segsize_all, is.finite(n_cells)), aes(x=flux_pumped, y=depletion_m3d_modflow, 
  ...
  ggsave(file.path("results", "RRCA12p_08_CompareMODFLOW-ADF_Scatter-MassBalanceVsDepletion+SegSize.png"),
         width = 120, height = 95, units = "mm")
