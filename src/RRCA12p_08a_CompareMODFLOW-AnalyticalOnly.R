...
p.scatter.capture <- 
  ...
  ggsave(file.path(onedrive_ws, "plots", paste0("RRCA12p_08_CompareMODFLOW-ADF_ScatterCapture_", analytical_model, "_", storage, "_AnalyticalOnly_", paste(str_BCs, collapse = "-"), ".png")),
...
p.scatter.depletion <- 
  ...
  scale_y_continuous(name = "Monthly Mean Depletion, MODFLOW [m\u00b3/d]") +
  scale_color_manual(name = "Season", values = pal.season) +
  ggsave(file.path(onedrive_ws, "plots", paste0("RRCA12p_08_CompareMODFLOW-ADF_ScatterDepletion_", analytical_model, "_", storage, "_AnalyticalOnly_", paste(str_BCs, collapse = "-"), ".png")),
         width = 120, height = 95, units = "mm")
...
fit_match_byWell %>% 
  ...
  ggsave(file.path(onedrive_ws, "plots", paste0("RRCA12p_08_CompareMODFLOW-ADF_Fit-MatchPrcByWell_", analytical_model, "_", storage, "_AnalyticalOnly_", paste(str_BCs, collapse = "-"), ".png")),
...
ggplot(fit_match_bySP, aes(y = prc_match, x = SP, color = n_total)) +
  ...
  ggsave(file.path(onedrive_ws, "plots", paste0("RRCA12p_08_CompareMODFLOW-ADF_Fit-MatchPrcBySP_", analytical_model, "_", storage, "_AnalyticalOnly_", paste(str_BCs, collapse = "-"), ".png")),
