...
np.savetxt(os.path.join(output_path, modelname+'_LPF-hk.txt'),
           mf.lpf.hk[0,:,:], fmt='%e', delimiter=' ')
np.savetxt(os.path.join(output_path, modelname+'_LPF-ss.txt'),
           mf.lpf.ss[0,:,:], fmt='%5.2e', delimiter=' ')
np.savetxt(os.path.join(output_path, modelname+'_LPF-sy.txt'),
           mf.lpf.sy[0,:,:], fmt='%5.2e', delimiter=' ')

np.savetxt(os.path.join(output_path, modelname+'_DIS-top.txt'),
           mf.dis.top[:,:], fmt='%10.6f', delimiter=' ')
np.savetxt(os.path.join(output_path, modelname+'_DIS-botm.txt'),
           mf.dis.botm[0,:,:], fmt='%6.2f', delimiter=' ')

np.savetxt(os.path.join(output_path, modelname+'_BAS6-ibound.txt'),
           mf.bas6.ibound[0,:,:], fmt='%1d', delimiter=' ')
np.savetxt(os.path.join(output_path, modelname+'_BAS6-strt.txt'),
           mf.bas6.strt[0,:,:], fmt='%10.6f', delimiter=' ')

np.savetxt(os.path.join(output_path, modelname+'_RCH-rech.txt'),
...
stream_df_sp1.to_csv(os.path.join(output_path, 'RRCA12p_STR_StressPeriod1.csv'), index=False,
...
seg_all.to_csv(os.path.join(output_path, 'RRCA12p_STR_Leakage.csv'), index=False,
...
well_data_all.to_csv(os.path.join(output_path, 'RRCA12p_WEL_StressPeriodData.csv'), index=False,
...
# save output
CHB_all.to_csv(os.path.join(output_path, 'RRCA12p_CHB_Leakage.csv'), index=False,
...
# save output
DRN_all.to_csv(os.path.join(output_path, 'RRCA12p_DRN_Leakage.csv'), index=False,
...
# save output
EVT_all.to_csv(os.path.join(output_path, 'RRCA12p_EVT_Flux.csv'), index=False,
...
np.savetxt(os.path.join(output_path, 'RRCA12p_Head-SS.txt'), head[0,:,:])
np.savetxt(os.path.join(output_path, 'RRCA12p_Head-End.txt'), head_end[0,:,:])
...
df_flux.to_csv(os.path.join(output_path, 'RRCA12p_BudgetFlux.csv'), index=False)
